...
import 'package:playmyhit/presentation/profile_screen/music_screen/my_music_view.dart';
      ...
      builder: (context, state){
        switch(state.runtimeType){
          case NavigateToMusicPageState:
            return mainUi(controller, context);
...
Widget mainUi(TabController controller, BuildContext context) => Scaffold(
  appBar: AppBar(
  ...
  body: TabBarView(
    controller: controller,
      children: [
        MyMusicView(myMusicPostAttachments: RepositoryProvider.of<PostsRepository>(context).postAttachments.where((element) => element.attachmentType == AttachmentType.audio).toList()),
